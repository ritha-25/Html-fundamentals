...
// let isChargeConnected=true
// console.log("This battery is in use"+batteryUsage)
// let warning=batteryPercentage<20 || !isChargeConnected
// console.log("Warning please charge ypur phone"+ warning)
// //cinema Ticket Pricing
// let adultTicket=10
// let chileTicket=5
// let totalTickets=adultTicket+chileTicket
// let isWeekend=true
// let discounts=(totalTickets>5 && isWeekend + totalTickets*0.15)
// console.log("the totla ticket price"+totalTickets+"rfw")
...
// let isPremium=true
// let speed=0.5*100
// let speedreduced=speed--
// let remainingData=monthlyLimit-usage
// console.log("remainig data"+remainingData+"GB")
...
// console.log("User can enter"+pass && hasIdVerfication)
